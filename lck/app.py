...
def test():
	...
	rank = soup.select('#app > div > div:nth-child(2) > article > div:nth-child(5) > div:nth-child(2) > div > div > div:nth-child(15) > div > table > tbody')
	t = []
	k = []
	r = []
	for x in rank:
	...
	return render_template('test.html',data_list = r)
